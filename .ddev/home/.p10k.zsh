# Generated by Powerlevel10k configuration wizard on 2020-02-07 at 22:06 UTC.
...
() {
  ...
  typeset -g POWERLEVEL9K_LEFT_SUBSEGMENT_SEPARATOR=$DDEV_POWERLINE_RIGHT_ARROW_THIN
  # Separator between same-color segments on the right.
  typeset -g POWERLEVEL9K_RIGHT_SUBSEGMENT_SEPARATOR=$DDEV_POWERLINE_LEFT_ARROW_THIN
  # Separator between different-color segments on the left.
  typeset -g POWERLEVEL9K_LEFT_SEGMENT_SEPARATOR=$DDEV_POWERLINE_RIGHT_ARROW
  # Separator between different-color segments on the right.
  typeset -g POWERLEVEL9K_RIGHT_SEGMENT_SEPARATOR=$DDEV_POWERLINE_LEFT_ARROW
  # The right end of left prompt.
  typeset -g POWERLEVEL9K_LEFT_PROMPT_LAST_SEGMENT_END_SYMBOL=$DDEV_POWERLINE_RIGHT_ARROW
  # The left end of right prompt.
  typeset -g POWERLEVEL9K_RIGHT_PROMPT_FIRST_SEGMENT_START_SYMBOL=$DDEV_POWERLINE_LEFT_ARROW
  ...
  typeset -g POWERLEVEL9K_DIR_ANCHOR_FOREGROUND=${BACKGROUND_COLOR/default/0}
  ...
  typeset -g POWERLEVEL9K_VCS_BRANCH_ICON="$DDEV_POWERLINE_VCS_BRANCH_ICON "
  POWERLEVEL9K_VCS_BRANCH_ICON=${(g::)POWERLEVEL9K_VCS_BRANCH_ICON}

  # Untracked files icon. It's really a question mark, your font isn't broken.
  # Change the value of this parameter to show a different icon.
  typeset -g POWERLEVEL9K_VCS_UNTRACKED_ICON=$DDEV_POWERLINE_VCS_UNTRACKED_ICON
  ...
  function my_git_formatter() {
    ...
    # *42 if have stashes.
    (( VCS_STATUS_STASHES        )) && res+="  ${clean}${DDEV_POWERLINE_VCS_STASH_ICON} ${VCS_STATUS_STASHES}"
    # ~42 if have merge conflicts.
    (( VCS_STATUS_NUM_CONFLICTED )) && res+="  ${conflicted}${DDEV_POWERLINE_VCS_CONFLICT_ICON} ${VCS_STATUS_NUM_CONFLICTED}"
    # 'merge' if the repo is in an unusual state.
    [[ -n $VCS_STATUS_ACTION     ]] && res+=" ${conflicted}${VCS_STATUS_ACTION}"
    # +42 if have staged changes.
    (( VCS_STATUS_NUM_STAGED     )) && res+="  ${modified}${DDEV_POWERLINE_VCS_STAGED_ICON} ${VCS_STATUS_NUM_STAGED}"
    # !42 if have unstaged changes.
    (( VCS_STATUS_NUM_UNSTAGED   )) && res+="  ${modified}${DDEV_POWERLINE_VCS_UNSTAGED_ICON} ${VCS_STATUS_NUM_UNSTAGED}"
